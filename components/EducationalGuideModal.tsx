      ...
      >
        ...
        <div className={`flex items-center justify-between px-6 py-4 border-b ${
          ...
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-xl bg-gradient-to-br from-blue-600 to-blue-400 text-white shadow-md shadow-blue-500/20">
              <BookOpen className="w-5 h-5" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-lg font-medium">الدليل التعليمي التفاعلي لتقرير COT</h2>
                <span className="px-2 py-0.5 text-[11px] font-medium rounded-full bg-blue-500/10 text-blue-500 border border-blue-500/20">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8 space-y-6">
          ...
          {activeTab === 'intro' && (
            <div className="space-y-6 animate-fade-in">
              <div className={`p-6 rounded-2xl border ${
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg font-medium">ببساطة شديدة: ما هو تقرير COT؟</h3>
              ...
              <div className="space-y-3">
                <h4 className="text-sm font-medium uppercase tracking-wider text-blue-500">رحلة صدور البيانات من السوق إلى منصتك</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className={`p-4 rounded-xl border relative ${
                    ...
                    <span className="text-xs font-mono font-medium px-2 py-0.5 rounded bg-blue-500/10 text-blue-500 border border-blue-500/20 mb-2 inline-block">
                      1. يوم الثلاثاء (الإغلاق)
                    </span>
                    <h5 className="font-medium text-sm mb-1">تسجيل العقود المفتوحة</h5>
                  ...
                  <div className={`p-4 rounded-xl border relative ${
                    ...
                    <span className="text-xs font-mono font-medium px-2 py-0.5 rounded bg-amber-500/10 text-amber-500 border border-amber-500/20 mb-2 inline-block">
                      2. يوم الجمعة (3:30 م بتوقيت نيويورك)
                    </span>
                    <h5 className="font-medium text-sm mb-1">نشر التقرير الرسمي</h5>
                    <p className={`text-xs leading-relaxed ${isLight ? 'text-slate-600' : 'text-slate-400'}`}>
                  ...
                  <div className={`p-4 rounded-xl border relative ${
                    ...
                    <span className="text-xs font-mono font-medium px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 mb-2 inline-block">
                      3. في منصة EG-Finance Fx
                    </span>
                    <h5 className="font-medium text-sm mb-1">التحليل اللحظي والمقارنة</h5>
                    <p className={`text-xs leading-relaxed ${isLight ? 'text-slate-600' : 'text-slate-400'}`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className={`p-4 rounded-xl border flex items-start gap-3 ${
                  ...
                  <div>
                    <h5 className="text-sm font-medium mb-1">التداول مع صُنّاع الاتجاه (Smart Money)</h5>
                    <p className={`text-xs leading-relaxed ${isLight ? 'text-slate-600' : 'text-slate-400'}`}>
                ...
                <div className={`p-4 rounded-xl border flex items-start gap-3 ${
                  ...
                  <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                  <div>
                    <h5 className="text-sm font-medium mb-1">تجنب فخاخ التصحيحات والتقلبات</h5>
                    <p className={`text-xs leading-relaxed ${isLight ? 'text-slate-600' : 'text-slate-400'}`}>
          ...
          {activeTab === 'trader_types' && (
            <div className="space-y-6 animate-fade-in">
              <div>
                <h3 className="text-base font-medium mb-1">من هم المتداولون في التقرير؟ وكيف نقرأ معسكراتهم؟</h3>
                <p className={`text-xs ${isLight ? 'text-slate-500' : 'text-slate-400'}`}>
                ...
                <div className={`p-6 rounded-2xl border relative overflow-hidden ${
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <h4 className="font-medium text-base">كبار المضاربين (Non-Commercials)</h4>
                ...
                <div className={`p-6 rounded-2xl border relative overflow-hidden ${
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <h4 className="font-medium text-base">المؤسسات التجارية (Commercials)</h4>
          ...
          {activeTab === 'net_simulator' && (
            <div className="space-y-6 animate-fade-in">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                  <h3 className="text-base font-medium">محاكي ميزان القوى وصافي المراكز (Net Positions Simulator)</h3>
                  <p className={`text-xs ${isLight ? 'text-slate-500' : 'text-slate-400'}`}>
              ...
              <div className={`p-6 rounded-2xl border flex flex-col items-center justify-center relative overflow-hidden ${
                ...
                <div className="w-full max-w-lg h-36 flex flex-col items-center justify-center relative">
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center">
                      <div className="px-4 py-2 rounded-xl bg-emerald-500 text-white font-medium text-xs sm:text-sm shadow-lg flex items-center gap-1.5 whitespace-nowrap">
                        <TrendingUp className="w-4 h-4" />
                        <span>عقود الشراء (Longs)</span>
                      </div>
                      <div className="w-0.5 h-6 bg-emerald-500/60"></div>
                      <div className="px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-400 font-mono font-medium text-xs border border-emerald-500/30">
                    ...
                    {/* Right Pan: SHORTS */}
                    <div className="flex flex-col items-center">
                      <div className="px-4 py-2 rounded-xl bg-rose-500 text-white font-medium text-xs sm:text-sm shadow-lg flex items-center gap-1.5 whitespace-nowrap">
                        <TrendingDown className="w-4 h-4" />
                        <span>عقود البيع (Shorts)</span>
                      </div>
                      <div className="w-0.5 h-6 bg-rose-500/60"></div>
                      <div className="px-3 py-1 rounded-full bg-rose-500/20 text-rose-400 font-mono font-medium text-xs border border-rose-500/30">
                ...
                <div className={`mt-4 px-4 py-2 rounded-xl border font-mono text-xs sm:text-sm font-medium flex items-center gap-2 ${
                ...
                <div className={`mt-4 w-full p-4 rounded-xl border flex items-start gap-3 transition-all ${sentimentBadge.color}`}>
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="font-medium text-sm">{sentimentBadge.title}</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className={`p-4 rounded-xl border ${isLight ? 'bg-slate-50 border-slate-200' : 'bg-slate-950/30 border-white/5'}`}>
                  <div className="flex items-center justify-between mb-2">
                    <label className="text-xs font-medium text-emerald-500 flex items-center gap-1.5">
                      <TrendingUp className="w-4 h-4" />
                      <span>عقود الشراء (Long Positions)</span>
                    </label>
                    <span className="font-mono font-medium text-xs">{simLongs.toLocaleString()}</span>
                  </div>
                  <input
                    type="range"
                    min="10000"
                ...
                <div className={`p-4 rounded-xl border ${isLight ? 'bg-slate-50 border-slate-200' : 'bg-slate-950/30 border-white/5'}`}>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="font-mono font-medium text-xs">{simShorts.toLocaleString()}</span>
                  </div>
                  <input
                    type="range"
                    min="10000"
          ...
          {activeTab === 'weekly_momentum' && (
            <div className="space-y-6 animate-fade-in">
              <div>
                <h3 className="text-base font-medium mb-1">كيف تقرأ "التغير الأسبوعي" (Weekly Change)؟</h3>
                <p className={`text-xs ${isLight ? 'text-slate-500' : 'text-slate-400'}`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className={`p-5 rounded-xl border ${
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-medium px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-500">الحالة 1: أقوى إشارة صعودية</span>
                    <TrendingUp className="w-5 h-5 text-emerald-500" />
                  </div>
                  <h4 className="font-medium text-sm mb-1 text-emerald-600 dark:text-emerald-400">تراكم شرائي حقيقي (Accumulation)</h4>
                ...
                <div className={`p-5 rounded-xl border ${
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-medium px-2 py-0.5 rounded bg-rose-500/20 text-rose-500">الحالة 2: أقوى إشارة هبوطية</span>
                    <TrendingDown className="w-5 h-5 text-rose-500" />
                  </div>
                  <h4 className="font-medium text-sm mb-1 text-rose-600 dark:text-rose-400">تصريف وتخارج مكثف (Distribution)</h4>
                  <div className="font-mono text-xs font-semibold mb-2 space-y-0.5 text-slate-600 dark:text-slate-300">
                ...
                <div className={`p-5 rounded-xl border ${
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-medium px-2 py-0.5 rounded bg-amber-500/20 text-amber-500">الحالة 3: فخ الصعود المؤقت</span>
                    <RefreshCw className="w-5 h-5 text-amber-500" />
                  </div>
                  <h4 className="font-medium text-sm mb-1 text-amber-600 dark:text-amber-400">تغطية بيوع فقط (Short Covering)</h4>
                  <div className="font-mono text-xs font-semibold mb-2 space-y-0.5 text-slate-600 dark:text-slate-300">
                ...
                <div className={`p-5 rounded-xl border ${
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-medium px-2 py-0.5 rounded bg-purple-500/20 text-purple-500">الحالة 4: جني أرباح وتصحيح</span>
                    <AlertTriangle className="w-5 h-5 text-purple-500" />
                  </div>
                  <h4 className="font-medium text-sm mb-1 text-purple-600 dark:text-purple-400">تصفية صفقات شراء (Long Liquidation)</h4>
                  <div className="font-mono text-xs font-semibold mb-2 space-y-0.5 text-slate-600 dark:text-slate-300">
          ...
          {activeTab === 'strategy' && (
            <div className="space-y-6 animate-fade-in">
              <div className={`p-5 rounded-2xl border ${
                ...
                <h3 className="text-base font-medium mb-1">خطة عمل المتداول: كيف تبني نتائجك الاستثمارية من التقرير؟</h3>
              ...
              <div className="space-y-4">
                ...
                <div className={`p-4 rounded-xl border flex items-start gap-3.5 ${
                  ...
                  <div className="w-8 h-8 rounded-xl bg-blue-600 text-white font-medium flex items-center justify-center shrink-0">
                    1
                  </div>
                  <div>
                    <h4 className="font-medium text-sm mb-1">الخطوة الأولى: تحديد الاتجاه العام (Smart Money Direction)</h4>
                    <p className={`text-xs leading-relaxed ${isLight ? 'text-slate-600' : 'text-slate-400'}`}>
                ...
                <div className={`p-4 rounded-xl border flex items-start gap-3.5 ${
                  ...
                  <div className="w-8 h-8 rounded-xl bg-blue-500 text-white font-medium flex items-center justify-center shrink-0">
                    2
                  </div>
                  <div>
                    <h4 className="font-medium text-sm mb-1">الخطوة الثانية: مطابقة التقرير مع الأخبار والتحليل الأساسي</h4>
                    <p className={`text-xs leading-relaxed ${isLight ? 'text-slate-600' : 'text-slate-400'}`}>
                ...
                <div className={`p-4 rounded-xl border flex items-start gap-3.5 ${
                  ...
                  <div className="w-8 h-8 rounded-xl bg-amber-600 text-white font-medium flex items-center justify-center shrink-0">
                    3
                  </div>
                  <div>
                    <h4 className="font-medium text-sm mb-1">الخطوة الثالثة: مراقبة وتيرة التغير الأسبوعي</h4>
                    <p className={`text-xs leading-relaxed ${isLight ? 'text-slate-600' : 'text-slate-400'}`}>
                ...
                <div className={`p-4 rounded-xl border flex items-start gap-3.5 ${
                  ...
                  <div className="w-8 h-8 rounded-xl bg-purple-600 text-white font-medium flex items-center justify-center shrink-0">
                    4
                  </div>
                  <div>
                    <h4 className="font-medium text-sm mb-1">الخطوة الرابعة: الانتباه للتطرف التاريخي (Sentiment Extremes)</h4>
                    <p className={`text-xs leading-relaxed ${isLight ? 'text-slate-600' : 'text-slate-400'}`}>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            {activeTab !== 'strategy' ? (
              <button
                ...
                className="flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium transition-all shadow-md shadow-blue-500/20"
              >
              ...
              <button
                onClick={onClose}
                className="flex-1 sm:flex-initial px-5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-medium transition-all shadow-md shadow-emerald-500/20"
              >
                جاهز للبدء والتطبيق! 🚀
              </button>
            )}
